-- Script corregido para mejorar el texto de las notificaciones de reservas pendientes
-- Con manejo de casos donde el contenido puede ser NULL
...
-- 2. Crear una función para generar notificaciones de reservas
...
-- 3. Crear o reemplazar el trigger para nuevas reservas
...
-- 4. Crear o reemplazar el trigger para actualizaciones de reservas
...
-- 5. Actualizar las notificaciones existentes de reservas pendientes (solo si tienen contenido)
UPDATE notificaciones
...
-- 6. Actualizar el formato de las notificaciones existentes de reservas pendientes
...
-- 7. Actualizar el formato de las notificaciones con el mensaje específico del problema
UPDATE notificaciones
SET contenido = REGEXP_REPLACE(
  contenido,
